...
.viewprice-btn {
        ...
        @media print {
            ...
            /* ITEM DESCRIPTION column - make it wrap text properly */
            ...
            /* Adjust other columns width for proper distribution */
...
<body>
    <div class="container">
        ...
        <div class="project-info">
            ...
            <div class="info-group">
                ...
                <input type="text" id="projectNameField" placeholder="Enter project name">
            </div>
            <div class="info-group">
        ...
        <table id="wiresTable">
            ...
            <tbody>
                ...
                <tr>
                    <td><textarea class="description-input" data-section="wires" rows="1">5.5 sq. mm. THHN, Phelps Dodge</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="unit-cost-input" value="5,800.00"></td>
                    <td class="text-right total-cost">5,800.00</td>
    ...
    <!-- Lighting Fixtures -->
        ...
        <table id="lightingFixturesTable">
            ...
            <tbody>
                <tr>
                    <td><textarea class="description-input" data-section="lightingFixtures" rows="1">12" Diammeter Domelight Honey Comb Reflctor with E27Base 26watts LED BULB</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="unit-cost-input" value="5,800.00"></td>
                    <td class="text-right total-cost">5,800.00</td>
                ...
                <tr>
                    <td><textarea class="description-input" data-section="lightingFixtures" rows="1">18 Watts GE Downlight 8" Diameter Round Warmwhite</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="unit-cost-input" value="5,800.00"></td>
                    <td class="text-right total-cost">5,800.00</td>
    ...
    <!-- AuxiliaryLighting Fixtures -->
        ...
        <table id="auxlightingFixturesTable">
            ...
            <tbody>
                <tr>
                    <td><textarea class="description-input" data-section="auxlightingFixtures" rows="1">ESP32 Microcontroller with Headers</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="unit-cost-input" value="5,800.00"></td>
                    <td class="text-right total-cost">5,800.00</td>
                ...
                <tr>
                    <td><textarea class="description-input" data-section="auxlightingFixtures" rows="1">ESP32 Expansion Board</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="unit-cost-input" value="5,800.00"></td>
                    <td class="text-right total-cost">5,800.00</td>
        ...
        <table id="outletsTable">
            ...
            <tbody>
                <tr>
                    <td><textarea class="description-input" data-section="outlets" rows="1">GROUNDING DUPLEX, UNIVERSAL OUTLET w/ safety shutter, 250V VAC, 15AMP, IP64, WITH PLATE AND COVER PANASONIC BRAND</textarea></td>
                ...
                <tr>
                    <td><textarea class="description-input" data-section="outlets" rows="1">Floor Outlet 2 GANG, ABSO BRAND</textarea></td>
        ...
        <div class="signatures">
            <div class="signature-row">
                <div class="signature-block">
                    ...
                    <div class="signature-name"><input type="text" name="prepared_name" value="Enter your Name" /></div>
        ...
        <div class="button-group">
            ...
            <button class="boq-btn" onclick="loadPage('bom_labor.php')">CREATE BOQ</button>
    ...
    <script>
        ...
        const materialOptions = {
            ...
            outlets: [
                'GROUNDING DUPLEX  UNIVERSAL OUTLET w/ safety shutter 16A, 250V, WIDE SERIES, (WEG 15829) with Plate and Cover, PANASONIC Brand',
...
// Function to show dropdown - only shows when typing and filters based on input
function showMaterialDropdown(input) {
  ...
  // Attach input listeners to description inputs - dropdown shows only when typing
function attachDescriptionListeners() {
    document.querySelectorAll('.description-input').forEach(input => {
        // Only show dropdown when user types (input event)
        ...
        const unitOptions = ['pcs', 'pc', 'set', 'sets', 'gal', 'roll', 'assy', 'kgs', 'liter', 'box', 'pack', 'meter', 'meters', 'lot'];
        ...
        async function openSavePage() {
            ...
            // Sync all textarea and input values to the DOM before capturing
            ...
            document.querySelectorAll('input[type="text"], input[type="number"], input[type="date"]').forEach(inp => {
                // For input fields, we need to set them in a way that will be captured
            ...
            let printableHTML = container.innerHTML;
            ...
            printableHTML = tempDiv.innerHTML;
            ...
            const fullHTML = `
                ...
                <div class="document-header">
                    ...
                    <div><strong>Total Floor Area:</strong> ${floorArea || 'N/A'}</div>
                    <div><strong>Date:</strong> ${dateValue || 'N/A'}</div>
                </div>
