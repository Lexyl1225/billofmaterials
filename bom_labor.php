    ...
    <style>
        * {
        ...
        .section-dropdown-item {
            ...
            font-size: 12px;
            font-weight: bold;
            border-bottom: 1px solid #b2fafa00;
        }
...
<body>
    <div class="container">
        ...
        <div class="project-info">
            ...
            <div class="info-group">
                ...
                <input type="text" id="projectFloorArea" placeholder="Enter total floor area">
            </div>
            <div class="info-group">
                <label>Date:</label>
        ...
        window.addEventListener('DOMContentLoaded', generateReferenceNo);
               ...
               <!-- Bill of Materials -->
        <div style="font-weight: bold; margin-bottom: 10px;">MATERIALS & LABOR COST ESTIMATE: BILL OF QUANTITIES SECTION</div>
        ...
        <table id="panelTable">
            <thead>
                <tr>
                    ...
                    <th colspan="2" style="text-align: center;">LABOR</th>
                    <th rowspan="2" style="width: 12%;">TOTAL COST</th>
                </tr>
                <tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="1,600.00"></td>
                    <td class="text-right material-total-cost">1,600.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">1,600.00</td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="unit-input" value="pcs"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="1,200.00"></td>
                    <td class="text-right material-total-cost">1,200.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">1,200.00</td>
                </tr>
            </tbody>
        </table>
        <div>
            ...
            <span class="section-btn-container">
                ...
                <div class="section-dropdown">
                    ...
                    <div class="section-dropdown-item" onclick="addSectionByType('panelSection', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>
        ...
        <table id="wiresTable">
            ...
            <tbody>
                <tr>
                    <td><textarea class="description-input" data-section="wires" rows="1">3.5 sq. mm Str. cu. Wire THHN, Phelps Dodge - Black</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="5,800.00"></td>
                    <td class="text-right material-total-cost">5,800.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">5,800.00</td>
                </tr>
                <tr>
                    <td><textarea class="description-input" data-section="wires" rows="1">3.5 sq. mm Str. cu. Wire THHN, Phelps Dodge - Red</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="5,800.00"></td>
                    <td class="text-right material-total-cost">5,800.00</td>
        ...
        <div>
            ...
            <span class="section-btn-container">
                ...
                <div class="section-dropdown">
                    ...
                    <div class="section-dropdown-item" onclick="addSectionByType('wiresSection', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>
    ...
    <!-- Lighting Fixtures -->
        ...
        <table id="lightingFixturesTable">
            ...
            <tbody>
                <tr>
                    <td><textarea class="description-input" data-section="lightingFixtures" rows="1">Down Light GE Brand 18watts Warm White</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="5,800.00"></td>
                    <td class="text-right material-total-cost">5,800.00</td>
                ...
                <tr>
                    <td><textarea class="description-input" data-section="lightingFixtures" rows="1">Dome Light 12" Diameter Honey Comb Reflector with E27 Base</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="5,800.00"></td>
                    <td class="text-right material-total-cost">5,800.00</td>
        ...
        <div>
            ...
            <span class="section-btn-container">
                ...
                <div class="section-dropdown">
                    ...
                    <div class="section-dropdown-item" onclick="addSectionByType('lightingSection', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>
            ...
            <!-- Auxiliary Lighting Fixtures -->
        <div id="auxlightingSection" class="bom-section">
        <div class="section-title">AUXILIARY LIGHTING FIXTURES:</div>
        <table id="auxlightingFixturesTable">
            <thead>
                <tr>
                    <th rowspan="2" style="width: 25%;">ITEM DESCRIPTION</th>
                    <th rowspan="2" style="width: 8%;">UNIT</th>
            ...
            <tbody>
                <tr>
                    <td><textarea class="description-input" data-section="auxlightingFixtures" rows="1">ESP32 DEV with Headers</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="5,800.00"></td>
                    <td class="text-right material-total-cost">5,800.00</td>
                ...
                <tr>
                    <td><textarea class="description-input" data-section="auxlightingFixtures" rows="1">ESP32 DEV Expansion Board</textarea></td>
                    <td><input type="text" class="unit-input" value="box"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="5,800.00"></td>
                    <td class="text-right material-total-cost">5,800.00</td>
        ...
        <div>
            <button class="add-row-btn" onclick="addRow('auxlightingFixturesTable')">+ Add Row</button>
            <button class="remove-row-btn" onclick="removeLastRow('auxlightingFixturesTable')">- Remove Row</button>
            <button class="delete-section-btn" onclick="deleteSection('auxlightingSection')">Delete Section</button>
            <span class="section-btn-container">
                <button class="add-section-btn" onclick="toggleSectionDropdown(this)">+ Add Section</button>
                <div class="section-dropdown">
                    <div class="section-dropdown-item" onclick="addSectionByType('auxlightingSection', 'panel')">PANEL BOARD AND CIRCUIT BREAKERS</div>
                    <div class="section-dropdown-item" onclick="addSectionByType('auxlightingSection', 'wires')">WIRES AND CABLES</div>
                    <div class="section-dropdown-item" onclick="addSectionByType('auxlightingSection', 'lighting')">LIGHTING FIXTURES</div>
                    <div class="section-dropdown-item" onclick="addSectionByType('auxlightingSection', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>    
                    <div class="section-dropdown-item" onclick="addSectionByType('auxlightingSection', 'outlets')">CONVENIENCE OUTLET AND SWITCHES</div>
                    <div class="section-dropdown-item" onclick="addSectionByType('auxlightingSection', 'conduit')">CONDUIT AND FITTINGS</div>
                    <div class="section-dropdown-item" onclick="addSectionByType('auxlightingSection', 'misc')">MISCELLANEOUS</div>
                </div>
            </span>
        </div>
        </div>
        ...
        <table id="outletsTable">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="240.00"></td>
                    <td class="text-right material-total-cost">8,400.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">8,400.00</td>
                </tr>
                <tr>
                    ...
                    <td><input type="number" class="qty-input" value="35"></td>
                    <td><input type="text" class="material-unit-cost-input" value="30.00"></td>
                    <td class="text-right material-total-cost">1,050.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">1,050.00</td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="100.00"></td>
                    <td class="text-right material-total-cost">700.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">700.00</td>
                </tr>
            </tbody>
        </table>
        <div>
            ...
            <span class="section-btn-container">
                ...
                <div class="section-dropdown">
                    ...
                    <div class="section-dropdown-item" onclick="addSectionByType('outletsSection', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>
        ...
        <div>
            ...
            <span class="section-btn-container">
                ...
                <div class="section-dropdown">
                    ...
                    <div class="section-dropdown-item" onclick="addSectionByType('conduitSection', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>
        ...
        <table id="miscTable">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="50.00"></td>
                    <td class="text-right material-total-cost">300.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">300.00</td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="5,000.00"></td>
                    <td class="text-right material-total-cost">10,000.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">10,000.00</td>
                </tr>
                <tr>
                    <td><textarea class="description-input" data-section="misc" rows="1">Electrical Fixtures circuit at 1/2-10am</textarea></td>
                    <td><input type="text" class="unit-input" value="pc"></td>
                    <td><input type="number" class="qty-input" value="1"></td>
                    <td><input type="text" class="material-unit-cost-input" value="200.00"></td>
                    <td class="text-right material-total-cost">200.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">200.00</td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="15.00"></td>
                    <td class="text-right material-total-cost">1,200.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">1,200.00</td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="200.00"></td>
                    <td class="text-right material-total-cost">1,000.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">1,000.00</td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value="250.00"></td>
                    <td class="text-right material-total-cost">2,500.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">2,500.00</td>
                </tr>
                <tr>
                    ...
                    <td><input type="number" class="qty-input" value="5"></td>
                    <td><input type="text" class="material-unit-cost-input" value="250.00"></td>
                    <td class="text-right material-total-cost">1,250.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value="0.00"></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">1,250.00</td>
                </tr>
            </tbody>
        </table>
        <div>
            ...
            <span class="section-btn-container">
                ...
                <div class="section-dropdown">
                    ...
                    <div class="section-dropdown-item" onclick="addSectionByType('miscSection', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>
        ...
        <table style="margin-top: 15px;">
            <tr class="total-row">
                ...
                <td id="grandTotal" colspan="2" style="text-align: right; font-weight: bold;">0.00</td>
            </tr>
        </table>
        ...
        <div class="signatures">
            <div class="signature-row">
                <div class="signature-block">
                    ...
                    <div class="signature-name"><input type="text" name="prepared_name" value="Johny Austria" /></div>
            ...
            <div class="signature-row">
                <div class="signature-block">
                    <div class="signature-label">NOTED AND APPROVED BY:</div>
                    <div class="signature-line"></div>
                    <div class="signature-name"><input type="text" name="noted_name" value="Alexander Fernandez" /></div>
                    <div class="signature-title"><input type="text" name="noted_position" value="Electrical Engineer" /></div>
                </div>
                <div class="signature-block">
                    <div class="signature-label">APPROVED BY:</div>
                    <div class="signature-line"></div>
                    <div class="signature-name"><input type="text" name="approved2_name" value="Ronal Lopez" /></div>
                    <div class="signature-title"><input type="text" name="approved2_position" value="Division HEAD" /></div>
                </div>
            </div>
            <div class="signature-row">
                <div class="signature-block">
        ...
        <div class="button-group">
            ...
            <button class="save-btn" onclick="openSavePage()">Save</button>
            <button class="bom-btn" onclick="loadPage('bom.php')">CREATE BOM</button>
            <button class="viewsave-btn" onclick="loadPage('save_bomboq.php')">View Save Files</button>
            <button class="viewprice-btn" onclick="loadPage('price_edit_bomboq.php')">View MCE</button>
    ...
    <script>
        ...
        const materialOptions = {
            ...
            lightingFixtures: [
                ...
                'WT8A Led Fluorescent tube, Warm white, 16W, 1800lm',
                'WT8A Led Fluorescent tube, Cool white, 16W, 1800lm',
                'WT8A Led Fluorescent tube, Warm White, 8W, 900lm',
                'WT8A Led Fluorescent tube, Daylight white, 8W, 900lm',
                'GE UNO RECESSED DOWNLIGTH; UNOORR8D3CCT14W-BL; CCT:3000K/4000K/5000K; 14W; 1250 LUMENS -Warm White',
                'GE UNO RECESSED DOWNLIGTH; UNOORR8D3CCT18W-BL; CCT:3000K/4000K/5000K; 18W; 1600 LUMENS -Warm White',
                'GE UNO RECESSED DOWNLIGTH; UNOORR8D3CCT24W-BL; CCT:3000K/4000K/5000K; 24W; 2100 LUMENS -Warm White',
                'SMD LED STRIPS 5050 Warm White, 220V 14.4W/METER, Eurolux Brand',
                'SMD LED STRIPS 5050 Cool White, 220V 14.4W/METER, Eurolux Brand',
                'SMD LED STRIPS 5050 Daylight, 220V 14.4W/METER, Eurolux Brand',
                'SMD LED STRIPS 5050 Blue Light, 220V 14.4W/METER, Eurolux Brand',
                'SMD LED STRIPS 5050 Red Light, 220V 14.4W/METER, Eurolux Brand',
                'SMD LED STRIPS 5050 Green Light, 220V 14.4W/METER, Eurolux Brand',
                'SMD LED 5050 End Cap (2 pcs), Eurolux Brand',
                'SMD LED 5050 Connector (2pin), Eurolux Brand',
                'SMD LED Connector Tube',
                'SMD LED Power Cable (1.5m), Eurolux Brand',
                '24" X 48" T8 Aluminum Louver Recessed Type w/ 2 x T8 Holder',
                '24" X 48" T8 Aluminum Louver Surface Type w/ 2 x T8 Holder',
                '12" X 48" T8 Aluminum Louver Recessed Type w/ 2 x T8 Holder',
                '12" X 48" T8 Aluminum Louver Surface Type w/ 2 x T8 Holder',
                
            ],
            auxlightingFixtures: [
                'SMD LED STRIPS WS2815 ADDRESSABLE RGB, 12V 100LEDS/METER',
                'SMD LED STRIPS WS2815 ADDRESSABLE RGBW, 12V 100LEDS/METER',
                '15mm x 20mm LED Aluminum Channel with White diffuser Cover, 1,5 meter',
                'Control Box 60cm x 40cm x 20cm (For power supply and controller)',
                'Arduino Nano ESP32S3 Micro Controller with Header',
                'Arduino Nano ESP32S3 Micro Controller without Header',
                'Arduino Nano ESP32S3 Expansion Board',
                'Power Supply 220AC/12VDC (400watts)',
                'Terminal Block for 1.25sq. mm wire (1n13bk)- DIN Rail Mount',
                'DIN Rail (slotted type) 1 meter',
                'Control Relay, 220VAC COIL, TeSysk-Model,(2NC/2NO), SCHNEIDER Brand',
                'ANLY TIMER With socket Din Rail Mount, 220VAC, ON DELAY, 0.1s to 100 hours',
                'Cable Spiral Wrap 8mm',
                '16 mm diameter Push Button switch (NO) -Illuminated-Green',
                '16 mm diameter Push Button switch (NC) -Illuminated-Red',
                '16 mm diameter Pilot Light -Green',
                '16 mm diameter Pilot Light -Red',  
                'Blind Revit (1/8" x 1/2")',
                '1.25 sq. mm TF Wire',
                '#18 AWG Str. cu. TF Wire -Red',
                '#18 AWG Str. cu. TF Wire -Black',
                '#18 AWG Str. cu. TF Wire -White',
                '#18 AWG Str. cu. TF Wire -Green',
                '#18 AWG Str. cu. TF Wire -Blue',
                'Shrinkable Tube 3/16" (4.8mm) - Black',
                'Shrinkable Tube 1/8" (3.2mm) - Black',
                'Heat Gun - 1500W',
                'Soldering Iron - 60W',
                'Solder Wire - 60/40 Rosin Core - 1/16" (1.6mm) - 1lb',
                'Flux Paste - 50g',
                'Desoldering Braid - 2.5mm x 1.5m'


             ],

            outlets: [
                'GROUNDING UNIVERSAL OUTLET (WEG1181K)  w/ safety shutter 16A, 250V, WIDE SERIES, WITH PLATE AND COVER (WEG 68029W-1) PANASONIC Brand',
                'GROUNDING UNIVERSAL OUTLET (WEG1181K)  w/ safety shutter 16A, 250V, WIDE SERIES, WITH PLATE AND COVER (WEG 68029W-1) PANASONIC Brand',
                'GROUNDING UNIVERSAL OUTLET 16A, 250V, (WEG 15829), PANASONIC Brand',
                '2-Gang GFCI Safety Outlet Ground Fault in Ivory Plate 20A (Designer Series) - DGFCI-201-PK, PANASONIC Brand',
                '1 GANG 1-DEVICE ,1 WAY SWITCH (WEG 5151 - 51K) WITH PLATE AND COVER (WEG6801W-1) PANASONIC Brand',
                '1 GANG 2-DEVICE ,1 WAY SWITCH (WEG 5151 - 51K) WITH PLATE AND COVER (WEG6802W-1) PANASONIC Brand',
                '1 GANG 3-DEVICE ,1 WAY SWITCH (WEG 5151 - 51K) WITH PLATE AND COVER (WEG6803W-1) PANASONIC Brand',
                '1 GANG 1-DEVICE ,LAN OUTLET CAT6/CAT5 (WEG24886) WITH PLATE AND COVER (WEG2488601W-1) PANASONIC Brand',
                '1 GANG 2-DEVICE ,LAN OUTLET CAT6/CAT5 (WEG24886) WITH PLATE AND COVER (WEG2488602W-1) PANASONIC Brand',
                '1 GANG 3-DEVICE ,LAN OUTLET CAT6/CAT5 (WEG24886) WITH PLATE AND COVER (WEG2488603W-1) PANASONIC Brand',
            ...
            misc: [
                'CAT6 UTP CABLE BELDEN BRAND-SHIELDED, 300 METERS/BOX',
                'SMOKE DETECTOR, PHOTOELECTRIC TYPE, PANASONIC BRAND',
                'HEAT DETECTOR, RATE OF RISE TYPE, PANASONIC BRAND',
                'MANUAL PULL STATION, PANASONIC BRAND',
                'FIRE ALARM SOUNDERS, PANASONIC BRAND',
                'SMOKE DETECTOR - NOTIFIER BRAND',
                'HEAT DETECTOR - NOTIFIER BRAND',
                'MANUAL PULL STATION - NOTIFIER BRAND',
                'FIRE ALARM SOUNDERS - NOTIFIER BRAND',
                '1.25 SQ. MM TF Wire - Red',
                '1.25 SQ. MM TF Wire - Black',
                '24-hr TIMER SWITCH, PANASONIC BRAND',
                'PHOTO CELL SWITCH, PANASONIC BRAND',
                'Angle Bar 1 1/2" x 1 1/2" x 3/16" x 6m',
                'Flat Bar 1/4" x 2" x 6m',
                'Flat Bar 1/8" x 2" x 6m',
                'Fullthread round Bar Bolt 3/8" with nut and washer',
                'Anchor Bolt 3/8" x 6" with nut and washer',
                'Anchor grip 3/8"',
                'nut and washer 3/8"',
                'Hex Bolt 3/8" with nut and washer',
                'Plastic tox screw with screw #8',
                'Terminal Lugs cu. 5.5 sq. mm.',
                'Terminal Lugs cu. 8.0 sq. mm.',
                'Terminal Lugs cu. 14.0 sq. mm.',
                'Terminal Lugs cu. 22.0 sq. mm.',
                'Terminal Lugs cu. 30.0 sq. mm.',
                'Terminal Lugs cu. 38.0 sq. mm.',
                'Terminal Lugs cu. 50.0 sq. mm.',
                'Solderless cu. Connector 5.5 sq. mm.',
                'Solderless cu. Connector 8.0 sq. mm.',
                'Solderless cu. Connector 14.0 sq. mm.',
                'Solderless cu. Connector 22.0 sq. mm.',
                'Solderless cu. Connector 30.0 sq. mm.',
                'Solderless cu. Connector 38.0 sq. mm.',
                'Solderless cu. Connector 50.0 sq. mm.',
                'Dymo Tagger Label Tape 3/8" - Black',
                'Dymo Tagger',
                'Rubber Tape - NITTO',
                'Mica Tube 3/8" diameter',
                'Mica Tube 1/2" diameter',
                'Flexible metallic conduit 3/8"',
                'Flexible metallic conduit 1/2"',
                'Flexible Metallic connector 3/8"',
                'Flexible Metallic connector 1/2"',
                'Island or Turco - Rust Converter',
                'G.I. Utility box #16(2"x4")',
                'G.I. Utility box #16(2"x4") with cover',
                'Junction Box with cover - hexagon',
                'Junction Box with cover - square',
                'Junction Box with cover - rectangular',
                'G.I. Square Box #16 with cover',
                'C-Purlins 2" x 4" x 20ft x 1.2mm',
                'C-Purlins 2" x 6" x 20ft x 1.2mm',
                'G.I. Wire #16',
                'Electrical Tape - Big Roll - Armak Brand',
                'Baby Roller 4" -HI TECH BRAND',
                'Lacquer Thinner - KINGS BRAND',
                'Epoxy Prime -Gray - Illinois Brand',
                'Hardiflex 9mm x 4ft x 8ft',
                'Hardiflex 12mm x 4ft x 8ft',
                'Cable Tie 4" - Black',
                'Cable Tie 8" - Black',
                'Drill Bit for Metal 1/8"',
                'Cutting disk 4"',
                'PORTLAND Cement',
                'Fine Sand (Cement Sand)',
                'Fine White Sand (Plaster Sand)',
                'Metal Black Screw 1" Pointed',
                'Pull Box 12" x 12" x 5"',
                'Wire Gutter 25cm x 30cm x 330cm',
                'Cable Clamp 3/8" (Metallic)',
                'Electrical Tape',
                'Rubber Molding',
                'Duct Tape',
                'Warning Tape',
        ...
        const unitOptions = ['pcs', 'pc', 'set', 'sets', 'gal', 'roll', 'assy', 'kgs', 'liter', 'box','mts','meter','lot','sht','bundle'];
        ...
        function calculateRowTotal(row) {
            ...
            const materialTotalCostCell = row.querySelector('.material-total-cost');
            const laborTotalCostCell = row.querySelector('.labor-total-cost');
            const rowTotalCostCell = row.querySelector('.row-total-cost');

            if (qtyInput && materialUnitCostInput && materialTotalCostCell) {
                // Formula 1: MATERIALS(TOTAL COST) = QTY Ãƒâ€” MATERIALS(UNIT COST)
                const qty = parseNumber(qtyInput.value);
                const materialUnitCost = parseNumber(materialUnitCostInput.value);
                const materialTotal = qty * materialUnitCost;
                materialTotalCostCell.textContent = formatNumber(materialTotal);

                // Formula 2: LABOR(TOTAL COST) = QTY Ãƒâ€” LABOR(UNIT COST)
                const laborUnitCost = parseNumber(laborUnitCostInput.value);
                const laborTotal = qty * laborUnitCost;
                laborTotalCostCell.textContent = formatNumber(laborTotal);

                // Formula 3: TOTAL COST = MATERIALS(TOTAL COST) + LABOR(TOTAL COST)
                const rowTotal = materialTotal + laborTotal;
                rowTotalCostCell.textContent = formatNumber(rowTotal);
            }
        }

        // Function to calculate grand total (sum of all TOTAL COST rowspan=2 cells)
        function calculateGrandTotal() {
            let grandTotal = 0;
            document.querySelectorAll('.row-total-cost').forEach(cell => {
        ...
        function recalculateAllTotals() {
            document.querySelectorAll('#panelTable tbody tr, #wiresTable tbody tr, #lightingFixturesTable tbody tr, #outletsTable tbody tr, #conduitTable tbody tr, #miscTable tbody tr').forEach(row => {
        ...
        function attachCalculationListeners() {
            document.querySelectorAll('.qty-input, .material-unit-cost-input, .labor-unit-cost-input').forEach(input => {
                input.addEventListener('input', function() {
        ...
        function getSectionFromTableId(tableId) {
            ...
            if (tableId === 'auxlightingFixturesTable') return 'auxlightingFixtures';
        ...
        function addRow(tableId) {
            ...
            // Clear material unit cost input
            const materialUnitCostInput = newRow.querySelector('.material-unit-cost-input');
            if (materialUnitCostInput) {
                materialUnitCostInput.value = '';
            }

            // Clear labor unit cost input
            const laborUnitCostInput = newRow.querySelector('.labor-unit-cost-input');
            if (laborUnitCostInput) {
                laborUnitCostInput.value = '';
            }

            // Clear total cost cells
            const materialTotalCostCell = newRow.querySelector('.material-total-cost');
            if (materialTotalCostCell) {
                materialTotalCostCell.textContent = '0.00';
            }

            const laborTotalCostCell = newRow.querySelector('.labor-total-cost');
            if (laborTotalCostCell) {
                laborTotalCostCell.textContent = '0.00';
            }

            const rowTotalCostCell = newRow.querySelector('.row-total-cost');
            if (rowTotalCostCell) {
                rowTotalCostCell.textContent = '0.00';
            }
        ...
        const sectionTypeTemplates = {
            ...
            auxlighting: {
                id: 'auxlightingSection',
                tableId: 'auxlightingFixturesTable',
                title: 'AUXILIARY LIGHTING FIXTURES:',
                dataSection: 'auxlightingFixtures'
            },
            outlets: {
                id: 'outletsSection',
        ...
        <table id="${newTableId}">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" class="material-unit-cost-input" value=""></td>
                    <td class="text-right material-total-cost">0.00</td>
                    <td><input type="text" class="labor-unit-cost-input" value=""></td>
                    <td class="text-right labor-total-cost">0.00</td>
                    <td class="text-right row-total-cost">0.00</td>
                </tr>
            </tbody>
        </table>
        <div>
            ...
            <span class="section-btn-container">
                ...
                <div class="section-dropdown">
                    ...
                    <div class="section-dropdown-item" onclick="addSectionByType('${newId}', 'auxlighting')">AUXILIARY LIGHTING FIXTURES</div>
        ...
        function clearForm() {
            if (confirm('Are you sure you want to clear the form? All data will be lost.')) {
                ...
                // Reset all material total-cost cells to 0.00
                document.querySelectorAll('.material-total-cost').forEach(cell => {
                    cell.textContent = '0.00';
                });
                
                // Reset all labor total-cost cells to 0.00
                document.querySelectorAll('.labor-total-cost').forEach(cell => {
                    cell.textContent = '0.00';
                });
                
                // Reset all row total-cost cells to 0.00
                document.querySelectorAll('.row-total-cost').forEach(cell => {
                    cell.textContent = '0.00';
                });
        ...
        async function openSavePage() {
            // Check if user is Guest
            if (userRole === 'guest') {
                alert('Guests are not allowed to save files. Please contact an administrator or user to save documents.');
                return;
            }
            ...
            const floorArea = document.getElementById('projectFloorArea').value;
            const dateValue = document.getElementById('dateField').value;
            const now = new Date();
            const dateCreated = now.toLocaleString();

            const container = document.querySelector('.container');
            
            // Clone the container and update all input/textarea values in the clone
            const tempDiv = container.cloneNode(true);
            
            // Update all textarea values from the original container
            const containerTextareas = container.querySelectorAll('textarea');
            const tempTextareas = tempDiv.querySelectorAll('textarea');
            tempTextareas.forEach((ta, index) => {
                if (containerTextareas[index]) {
                    ta.textContent = containerTextareas[index].value;
                    ta.innerHTML = containerTextareas[index].value;
                    ta.value = containerTextareas[index].value;
                }
            });
            
            // Update all input values from the original container
            const containerInputs = container.querySelectorAll('input[type="text"], input[type="number"], input[type="date"]');
            const tempInputs = tempDiv.querySelectorAll('input[type="text"], input[type="number"], input[type="date"]');
            tempInputs.forEach((inp, index) => {
                if (containerInputs[index]) {
                    inp.setAttribute('value', containerInputs[index].value);
                    inp.value = containerInputs[index].value;
                }
            });
            
            // Update all select (dropdown) values from the original container
            const containerSelects = container.querySelectorAll('select');
            const tempSelects = tempDiv.querySelectorAll('select');
            tempSelects.forEach((sel, index) => {
                if (containerSelects[index]) {
                    sel.value = containerSelects[index].value;
                    const selectedOption = sel.querySelector('option:checked');
                    if (selectedOption) {
                        sel.textContent = selectedOption.textContent;
                    }
                }
            });
            
            // Update all calculated cell values (material-total-cost, labor-total-cost, row-total-cost)
            const containerTotalCells = container.querySelectorAll('.material-total-cost, .labor-total-cost, .row-total-cost');
            const tempTotalCells = tempDiv.querySelectorAll('.material-total-cost, .labor-total-cost, .row-total-cost');
            tempTotalCells.forEach((cell, index) => {
                if (containerTotalCells[index]) {
                    cell.textContent = containerTotalCells[index].textContent;
                }
            });
            
            // Remove buttons and controls
            tempDiv.querySelectorAll('.button-group, .add-row-btn, .remove-row-btn, .delete-section-btn, .add-section-btn, .section-btn-container').forEach(el => {
                el.remove();
            });
            
            // Get the innerHTML from the modified clone
            let printableHTML = tempDiv.innerHTML;
            ...
            try {
                ...
                try {
                    ...
                    alert('Error saving document: Invalid server response');
                    return;
                }
                
                if (result.success) {
                    alert('Document "' + documentName + '" has been saved successfully to the server!');
                    window.location.href = 'save_bomboq.php';
                } else {
                    alert('Error saving document: ' + (result.message || 'Unknown error'));
                }
            } catch (error) {
                console.error('Error saving to server:', error);
                alert('Error saving document to server: ' + error.message);
            }
        }
